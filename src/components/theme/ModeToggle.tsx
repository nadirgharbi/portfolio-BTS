...
export function ModeToggle() {
  ...
  return (
    <Button variant="outline" size="icon" className="rounded-xl bg-default-color hover:bg-primary-color/10 dark:bg-primary-color dark:hover:bg-primary-color/90 border border-primary-color/20 dark:border-default-color/20" onClick={handleMode}>
