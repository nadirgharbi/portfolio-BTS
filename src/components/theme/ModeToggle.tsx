...
export function ModeToggle() {
	...
	return (
		<Button variant="outline" size="icon" className="rounded-xl bg-default-color hover:bg-slate-200 dark:bg-primary-color dark:hover:bg-slate-900" onClick={handleMode}>
