...
export const BannerScroller = () => {
  const logoCSS: string =
    "text-primary/75 dark:text-default/75 w-20 h-20" as const;
  ...
  const logoSkills: Array<{ icon: ReactNode; alt: string }> = [
    ...
    { icon: <SiC className={logoCSS} />, alt: "C" },
  ...
  return (
    <>
      <div
        className={`scroller max-w-full self-center overflow-hidden md:[mask:linear-gradient(90deg,_transparent,_white_20%,_white_80%,_transparent)] animate-fade-in`}
      >
        <NavLink to={"/skills"}>
