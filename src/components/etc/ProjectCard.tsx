...
export const ProjectCard: React.FC<ProjectProps> = ({ title, description, tags, imageUrl, hrefLink, hasSource, strongWords }) => {
	return (
		<>
			<Card className="flex flex-col justify-between max-w-md pt-12 mb-20 bg-default hover:bg-primary/5 dark:bg-primary dark:hover:bg-default/5 transition-all rounded-lg relative z-[900]">
				<div>
					...
					<CardContent className="space-y-2">
						...
						{strongWords && <p className="italic font-semibold text-primary/60 dark:text-default/80">Note: {strongWords}</p>}
					</CardContent>
				</div>
				<CardFooter>
