...
import { useTheme } from "./settings/theme-provider";
...
export function ModeToggle() {
	...
	return (
		<Button variant="outline" size="icon" className="rounded-xl bg-slate-100 dark:bg-slate-800 border-" onClick={handleMode}>
