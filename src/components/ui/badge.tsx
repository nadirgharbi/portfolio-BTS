...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border border-secondary px-2.5 py-px text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-secondary dark:focus:ring-zinc-300",
  {
    variants: {
      variant: {
        default:
