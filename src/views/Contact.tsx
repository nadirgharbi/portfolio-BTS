				...
				<div className="flex flex-col gap-8">
									...
									<div className="grid w-full items-center gap-4">
										...
										<div className="flex flex-col space-y-1.5">
											...
											<Input
												...
												type="email"
												name="email"
												onChange={(e) => setContactInfos((prev) => ({ ...prev, email: e.target.value }))}
											/>
										</div>
										...
										<div className="flex flex-col space-y-1.5">
											...
											<Textarea
												...
												maxLength={512}
												className="max-h-40"
												onChange={(e) => setContactInfos((prev) => ({ ...prev, message: e.target.value }))}
											/>
										</div>
									</div>
					...
					<div className="w-full animate-fade-up">
						<div className="flex justify-center gap-3 w-full animate-fade-up">
							...
							<Button
								className="flex gap-2 w-full bg-primary dark:bg-default"
								data-tooltip-id="tooltip-social"
								data-tooltip-content={"LinkedIn"}
								data-tooltip-place="bottom"
								onClick={() => window.open("https://www.linkedin.com/in/nadirgharbi8310/", "_blank")}>
							...
							<Button
								...
								data-tooltip-place="bottom"
								onClick={() => window.open("https://github.com/nadirgharbi", "_blank")}>
							...
							<Button
								...
								data-tooltip-place="bottom"
								onClick={() => window.open("https://www.reddit.com/user/ShipProfessional6855/", "_blank")}>
