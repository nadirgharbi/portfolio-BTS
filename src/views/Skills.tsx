...
export const Skills = () => {
	...
	const changeStyle = `${isScrolled ? "bg-primary/50 backdrop-blur-2xl transition-all" : " "}`;
	...
	return (
		<>
			<div className="min-h-screen flex flex-col items-center px-6 lg:px-32 py-40 gap-24 text-primary dark:text-default bg-white dark:bg-primary">
				...
				<div className={`grid grid-cols-2 md:grid-cols-4 gap-12 sticky top-20 p-10  w-screen md:w-auto md:relative z-[900] ` + changeStyle}>
				...
				{/* BANNER SCROLLER */}
				<div className="grid grid-cols-2 md:grid-cols-5 xl:grid-cols-10 justify-items-center gap-10 pt-20 relative w-full md:w-2/3 mx-auto animate-fade-up z-[99]">
					{logoSkills.map((logo) => (
