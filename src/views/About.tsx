...
import BannerNumbers from "@/components/etc/BannerNumbers";

export const About = () => {
  const isInCompany = false;
  const companyInfo = { name: "AVIS2SANTE", location: "SIX-FOURS-LES-PLAGES", href: "https://avis2sante.fr" };
        ...
        <div className="space-y-16 text-center lg:text-start w-full lg:max-w-6xl">
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg leading-relaxed">
              ...
              , étudiant en <span className="font-light">{studiesData[0].description}</span>{" "}
              <span className="font-semibold">à l'école {studiesData[0].school}</span> à {studiesData[0].location}.
              {isInCompany ? (
                <>
                  {" "}
                  Je suis actuellement en alternance au sein de l'entreprise{" "}
            ...
            <div className="flex flex-wrap flex-row max-lg:justify-center gap-12 py-5">
              ...
              <div className="flex flex-col w-[22rem] gap-3">
                ...
                <p className="lg:text-start font-light">
                  J'aime stimuler ma réflexion avec des jeux de logique et de stratégie comme les échecs, le sudoku ou autres casse-tête.
                </p>
              </div>
              ...
              <div className="flex flex-col w-[22rem] gap-3">
                ...
                <p className="lg:text-start font-light">
                  Au-delà du divertissement, les jeux vidéo ont été pour moi une véritable révélation. C'est en me demandant comment donner vie à ces mondes
                  interactifs que mon parcours de développeur a commencé.
                </p>
              </div>
